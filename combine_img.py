...
text = ["Sample Text 1", "ffffffffffffffffffffffffffffffffffff", "Sample Text 3"]

font_size = 120

font = ImageFont.truetype("/data/lychen/code/web/ai-browser/Times New Roman.ttf", font_size)
